---
name: members-policies-medicare-by-carrier
description: Miembros y pólizas de Medicare (año en curso), desglosado por carrier (o.Carrier)
domain: medicare
tables:
  - claro_bi.BOB_TD
  - claro_bi.dim_cslb
...
tags: [members, policies, medicare, bob, by-carrier]
---

# Members / Policies Numbers — Medicare por Carrier

## Cuándo usar esta consulta

Misma métrica y mismas reglas de filtrado que `members-policies-medicare.md`, pero
desglosada por aseguradora (`o.Carrier`) en vez de un total único.
