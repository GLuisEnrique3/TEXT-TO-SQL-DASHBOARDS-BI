---
name: members-policies-medicare-by-state
description: Miembros y pólizas de Medicare (año en curso), desglosado por estado (o.State)
domain: medicare
tables:
  - claro_bi.BOB_TD
  - claro_bi.dim_cslb
...
tags: [members, policies, medicare, bob, by-state]
---

# Members / Policies Numbers — Medicare por State

## Cuándo usar esta consulta

Misma métrica y mismas reglas de filtrado que `members-policies-medicare.md`, pero
desglosada por estado (`o.State`, de `dim_cslb`) en vez de un total único.
