---
name: members-policies-medicare-by-agency
description: Miembros y pólizas de Medicare (año en curso), desglosado por agencia (a.Name_Agencies)
domain: medicare
tables:
  - claro_bi.BOB_TD
  - claro_bi.dim_cslb
...
tags: [members, policies, medicare, bob, by-agency]
---

# Members / Policies Numbers — Medicare por Agencia
...
- Ver `members-policies-medicare.md` para el detalle de cada regla de filtrado aplicada
  (no filtra `Val_BOB_TD = 1` — intencional, ver esa consulta).
