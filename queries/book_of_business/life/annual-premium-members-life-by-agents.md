---
name: annual-premium-members-life-by-agents
description: Prima anual y miembros totales de Life (año en curso), desglosado por agente
domain: life
tables:
  - claro_bi.BOB_TD
  - claro_bi.dim_cslb
...
tags: [premium, members, life, bob, by-agent]
---

# Annual Premium / Members — Life por Agente

## Cuándo usar esta consulta

Misma métrica y mismas reglas de filtrado que `annual-premium-members-life-by-agency.md`,
pero desglosada por agente (`c.Contact_Full_name_Formula__c`) en vez de por agencia.
