---
name: annual-premium-members-supplementary-by-risk-policies
description: Prima anual y miembros de Supplementary en estados de riesgo (Binder Payment, Late Payment), por estado de póliza
...
tags: [premium, members, supplementary, bob, risk, by-status]
---

# Annual Premium / Members — Supplementary Pólizas en Riesgo

## Cuándo usar esta consulta

Responde: "¿cuál es la prima anual y los miembros de pólizas de Supplementary en un estado
de riesgo (pago pendiente o atrasado), desglosado por ese estado?" A diferencia de
`annual-premium-members-supplementary-by-agency.md`, **no** excluye `NR`/`Terminated` — en
su lugar filtra explícitamente a solo los estados de riesgo.
