---
name: annual-premium-members-supplementary-by-policy-type
description: Prima anual y miembros totales de Supplementary (año en curso), desglosado por tipo de póliza (pt.Policy_Type__c)
...
tags: [premium, members, supplementary, bob, by-policy-type]
---

# Annual Premium / Members — Supplementary por Tipo de Póliza

## Cuándo usar esta consulta

Misma métrica y mismas reglas de filtrado que
`annual-premium-members-supplementary-by-agency.md`, pero desglosada por tipo de póliza
(`pt.Policy_Type__c`, vía `dim_policy_type`) en vez de por agencia.
