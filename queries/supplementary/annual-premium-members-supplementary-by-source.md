---
name: annual-premium-members-supplementary-by-source
description: Prima anual y miembros totales de Supplementary (año en curso), desglosado por fuente/origen (src.Source__c)
...
tags: [premium, members, supplementary, bob, by-source]
---

# Annual Premium / Members — Supplementary por Source

## Cuándo usar esta consulta

Misma métrica y mismas reglas de filtrado que
`annual-premium-members-supplementary-by-agency.md`, pero desglosada por fuente/origen del
negocio (`src.Source__c`, vía `dim_source`) en vez de por agencia.
