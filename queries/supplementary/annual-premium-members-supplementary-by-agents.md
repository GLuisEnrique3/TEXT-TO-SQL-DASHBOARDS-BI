---
name: annual-premium-members-supplementary-by-agents
description: Prima anual y miembros totales de Supplementary (año en curso), desglosado por agente
...
tags: [premium, members, supplementary, bob, by-agent]
---

# Annual Premium / Members — Supplementary por Agente

## Cuándo usar esta consulta

Misma métrica y mismas reglas de filtrado que
`annual-premium-members-supplementary-by-agency.md`, pero desglosada por agente
(`c.Contact_Full_name_Formula__c`) en vez de por agencia.
