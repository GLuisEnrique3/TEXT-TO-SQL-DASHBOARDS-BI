---
name: annual-premium-members-life-by-policy-type
description: Prima anual y miembros totales de Life (año en curso), desglosado por tipo de póliza (pt.Policy_Type__c)
domain: life
tables:
  - claro_bi.BOB_TD
  - claro_bi.dim_cslb
...
tags: [premium, members, life, bob, by-policy-type]
---

# Annual Premium / Members — Life por Tipo de Póliza

## Cuándo usar esta consulta

Misma métrica y mismas reglas de filtrado que `annual-premium-members-life-by-agency.md`,
pero desglosada por tipo de póliza (`pt.Policy_Type__c`, vía `dim_policy_type`) en vez de
por agencia.
