---
name: annual-premium-members-life-by-carrier
description: Prima anual y miembros totales de Life (año en curso), desglosado por carrier (o.Carrier)
domain: life
tables:
  - claro_bi.BOB_TD
  - claro_bi.dim_cslb
...
tags: [premium, members, life, bob, by-carrier]
---

# Annual Premium / Members — Life por Carrier

## Cuándo usar esta consulta

Misma métrica y mismas reglas de filtrado que `annual-premium-members-life-by-agency.md`,
pero desglosada por aseguradora (`o.Carrier`) en vez de por agencia.
